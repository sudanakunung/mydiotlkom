          ...
          <nav class="navbar navbar-dark" style="display: block; padding: 8px 0px; background: rgb(44,103,203); background: linear-gradient(90deg, rgba(44,103,203,1) 0%, rgba(24,15,72,1) 100%);">
            <div style="display:flex;justify-content:space-between">
              ...
              if(!isset($navbar_back) || isset($show_menu)){ ?>
                  <button class="navbar-toggler js-offcanvas-trigger" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation" data-offcanvas-trigger="off-canvas" style="min-width: 60px; border-color: transparent !important;">
                      <!-- <span class="navbar-toggler-icon"></span> -->
                      <img src="<?= base_url('assets/images/menu.png'); ?>" class="img-fluid" style="width: auto; height: 30px;">
                      <?php 
                  ...
                  if(!isset($show_menu)){ ?>
                    ...
                    <div class="kategori-chat">
                      <a href="<?= base_url('song-by-category'); ?>">
                        <img class="mr-3" src="<?= base_url('assets/images/kategori.png'); ?>" style="height: 28px; width: auto;">
                      </a>
                      <!-- <a onclick="show_list()">
