    ...
    <div class="d-block d-sm-none">
        <div class="footer-mobile">
            <div class="row">
                ...
                <div class="col-3 py-2 text-center" id="friends">
                    <?php
                ...
                <div class="col-3 py-2 text-center" id="notification">
                    <?php
                    if (!$this->session->has_userdata('memberLogin')) {
                ...
                <div class="col-3 py-2 text-center" id="profile">
                    <?php
                    /* if (!$this->session->has_userdata('memberLogin')) {
            ...
            <div class="modal-body example-video-2">
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col love-box">
                        <a href="#" class="love" login-status="" love-status="" song-id="" onclick="love_click(); return false;">
                    ...
                    <div class="col" id="cast" data-placement="top" data-content="Cast video to your TV">
                    ...
                    <div class="col-5 text-center">
                        <div class="row align-items-center bg-white rounded">
                            <div class="col-4 text-left p-0">
                                <button class="pitchControl btn btn-primary form-control" pitch-method="minus" style="border: none; background-color: #212563;">
                            ...
                            <div class="col-4 text-right p-0">
                                <button class="pitchControl btn btn-primary form-control" pitch-method="plus" style="border: none; background-color: #212563;">
                                    <span style="color: white;">+</span>
                                </button>
                            </div>
                        </div>
...
<div class="modal" id="exampleModal10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 5px; border-style: solid; border-width: thin; border-color: #212564;">
            <div class="modal-body" style="background: linear-gradient(1deg, rgba(44,103,203,1) 0%, rgba(24,15,72,1) 100%);">
                <div class="h-25">&nbsp;</div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="col-11 col-md-5 col-lg-5">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-8 mt-5">
                                    <a href="Javascript.void(0)" id="emaillogin" class="btn btn-primary form-control">LOG IN</a>
                                </div>
                                        ...
                                        <div class="col-12">
                                            <form id="login-email">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-6">
                                                        <a href="Javascript.void(0)" class="btn btn-outline-light form-control login">CLOSE</a>
                                                    </div>
...
<img src="<?= base_url('assets/images/scroll_to_top.png'); ?>" class="icon-scroll-top" onclick="scrollToTop();" style="display: none;">
            ...
            .done(function(data) {
                ...
                if(data.status == 200){
                    if(status == "0"){
                        ...
                        $('.love-icon').attr("src", "<?= base_url('assets/images/love_white.jpg'); ?>");
...
<script>
    ...
    function mydiolimit_disable(url, songtitle, artist, poster, song, songId) {
        ...
        if(cc.session){
            ...
            if (user != "") {
                ...
                $("#cast").popover('enable');
                setCookie("username2", "Mydiosing Lite 2", 30);
            }
            $("#cast").attr("data-placement", "top");
            $("#cast").attr("data-content", "Stop casting to TV");
            window.setTimeout(function () {
                $("#cast").popover('show');
            }, 2000);
    ...
    function cast_stop() {
        ...
        $(".karafun-icon").attr("src", "./assets/images/karafun.jpg");
    }
    ...
    function mydioclip(url, songtitle, recordId, urlPoster) {
        ...
        poster = ['<?php echo base_url('home/images/advert1.jpg');?>', '<?php echo base_url('home/images/advert2.jpg');?>', '<?php echo base_url('home/images/advert3.jpg');?>', '<?php echo base_url('home/images/advert4.jpg');?>', '<?php echo base_url('home/images/advert5.jpg');?>', '<?php echo base_url('home/images/advert6.jpg');?>', '<?php echo base_url('home/images/advert7.jpg');?>'];
        //alert(url);
        $.ajax({
...
$('#signinGoogle').click(function(event) {
    ...
    gapi.auth2.authorize({
        ...
        client_id: '292287579277-brerijk9poi2sn1hc4gdk7eng9pdmfct.apps.googleusercontent.com',
...
function uploadVideo(){
    $(".queue-content").html("<img src='<?php echo base_url('home/images/advert1.jpg');?>' class='lazyload'>");
    $(".queue-content").append("<img src='<?php echo base_url('home/images/advert2.jpg');?>' class='lazyload'>");
    $(".queue-content").append("<img src='<?php echo base_url('home/images/advert3.jpg');?>' class='lazyload'>");
    $(".queue-content").append("<img src='<?php echo base_url('home/images/advert4.jpg');?>' class='lazyload'>");
    $(".queue-content").append("<img src='<?php echo base_url('home/images/advert5.jpg');?>' class='lazyload'>");
    $(".queue-content").append("<img src='<?php echo base_url('home/images/advert6.jpg');?>' class='lazyload'>");
    $(".queue-content").append("<img src='<?php echo base_url('home/images/advert7.jpg');?>' class='lazyload'>");
