                            ...
                            <form id="register">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="name" type="text" class="text-white form-control register" id="name" placeholder="Name" aria-describedby="name" style="border-left: transparent;" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="email" type="text" class="text-white form-control register" id="email" placeholder="Email Address" aria-describedby="email" style="border-left: transparent;" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="birthday" type="text" class="text-white form-control register datepicker" id="birthday" placeholder="Birthday" aria-describedby="birthday" style="border-left: transparent; padding: .375rem .75rem;" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="address" type="text" class="text-white form-control register" id="validationDefaultUsername" placeholder="Location" aria-describedby="address" style="border-left: transparent;" required>
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <input name="password" type="password" class="text-white form-control register" id="password" placeholder="Password">
                                </div>

                                <div class="form-group">
                                    <input name="confirm_password" type="password" class="text-white form-control register" id="confirm_password" placeholder="Confirm Password">
                                </div>
