...
function(a, b) {
    ...
    g.prototype.init = function() {
        ...
        c.role && (f.role = c.role), a.utils.supportTransition || d.push(e.createModifierClass(c.baseClass, c.supportNoTransitionsClass)), e.cssModifiers(c.modifiers, d, c.baseClass), this.$element.attr(f).addClass(d.join(" ")), this.$content = b("." + c.contentClass), this._contentOpenClasses = [], e.cssModifiers(c.modifiers, this._contentOpenClasses, c.contentClass), this._modalOpenClasses = [c.modalClass, e.classes.isClosed], e.cssModifiers(c.modifiers, this._modalOpenClasses, c.modalClass), this._bodyOpenClasses = [c.bodyModifierClass + "--visible"], e.cssModifiers(c.modifiers, this._bodyOpenClasses, c.bodyModifierClass), c.modifiers.toLowerCase().indexOf("reveal") >= 0 ? this.transitionElement = this.$content[0] : this.transitionElement = this.element
        ...
        c = b(e.target ? e.target : "[" + g + "='" + f + "']"), new a.componentNamespace.OffcanvasTrigger(c[0], {
            offcanvas: f
        }).init()
